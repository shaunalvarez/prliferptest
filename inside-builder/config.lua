...
Config.jobrequirement1 = true --whether work requires a job
Config.jobname1 = 'miner' --name of the job that is required
...
Config.Miner = {
	['BossSpawn'] = { 
		Pos = {x = -283.1, y = -989.67, z = 31.18, h = 341.94}, --Place of commencement of work vector4(-283.1, -989.67, 31.18, 341.94)
		Type  = 'a_m_y_stbla_02', --model ped
	}
}
