...
AddEventHandler('inventory:client:OpenMechanicShop', function()
    ...
    QBCore.Functions.Notify("You must sign on duty first", "error", 5000) -- [text] = message, [type] = primary | error | success, [length] = time till fadeout.
end
end)
...
AddEventHandler('tuner-autos:Turbo', function()
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Turbo", 5000, false, true, {
                    ...
                    local success = exports['qb-lock']:StartLockPickCircle(1,30) --StartLockPickCircle(1,10) 1= how many times, 30 = time in seconds
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Turbo!'stu tu tu'")
                        ...
                        QBCore.Functions.Notify("Failed You Snapped A Bolt..", "error")
                        ClearPedTasks(playerPed)
                    end
    ...
    QBCore.Functions.Notify("Do you work for tuner?", "error", 4000)
end
end)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 1 Transmission", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 1 Tranny")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 2 Transmission", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 2 Tranny")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 3 Transmission", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 3 Tranny")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 1 Engine", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 1 Engine")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 2 Engine", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 2 Engine")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing A Stage 3 Engine", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 3 Engine")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Engine", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed A Stage 4 Engine")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 1 Brakes", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 1 Brakes")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 2 Brakes", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 2 Brakes")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 3 Brakes", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 3 Brakes")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 1 Suspension", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 1 Suspension")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 2 Suspension", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 2 Suspension")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 3 Suspension", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 3 Suspension")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Installing Stage 4 Suspension", 5000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
                    ...
                    if success then
                        StopAnimTask(ped, dict, "machinic_loop_mechandplayer", 1.0)
                        QBCore.Functions.Notify("Success You Installed Stage 4 Suspension")
                        ClearPedTasksImmediately(PlayerPedId())
                                     SetVehicleModKit(vehicle, 0)
	...
	if vehicle ~= nil and vehicle ~= 0 then
		...
		if #(pos - vehpos) < 4.0 and not IsPedInAnyVehicle(ped) then
			...
			if #(pos - drawpos) < 2.0 and not IsPedInAnyVehicle(ped) then
                ...
                QBCore.Functions.Progressbar("tuner_Transmission", "Repairing car", 20000, false, true, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
...
AddEventHandler("tuner:Engines1", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 1 Engine", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
   ...
   if success then
        ...
        QBCore.Functions.Notify("You must sign on duty first", "error", 5000) 
        ClearPedTasks(playerPed)
    end    
...
AddEventHandler("tuner:Engines2", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 2 Engine", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Engines3", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 3 Engine", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Engines4", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 4 Engine", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Transmission1", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 1 Tranny", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Transmission2", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 2 Tranny", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Transmission3", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting A Stage 3 Tranny", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Brakeslv1", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 1 Brakes", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Brakeslv2", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 2 Brakes", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Brakeslv3", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 3 Brakes", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Suslv1", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 1 Suspension", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Suslv2", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 2 Suspension", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Suslv3", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 3 Suspension", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Suslv4", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting Stage 4 Suspension", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler("tuner:Turbos", function()
    QBCore.Functions.Progressbar("tuner_Transmission", "Crafting", 5000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
