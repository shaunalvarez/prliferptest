...
QBCore.Functions.CreateUseableItem("turbo", function(source, item)
  ...
  QBCore.Functions.CreateUseableItem("translv1", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:TRANSLV1", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("translv2", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:TRANSLV2", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("translv3", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:TRANSLV3", source, item.name)
  end)

  QBCore.Functions.CreateUseableItem("englv1", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:ENGLV1", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("englv2", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:ENGLV2", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("englv3", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:ENGLV3", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("englv4", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:ENGLV4", source, item.name)
  end)


  QBCore.Functions.CreateUseableItem("suslv1", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:SUSLV1", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("suslv2", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:SUSLV2", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("suslv3", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:SUSLV3", source, item.name)
  end)

  QBCore.Functions.CreateUseableItem("suslv4", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:SUSLV4", source, item.name)
  end)
  
  QBCore.Functions.CreateUseableItem("brakeslv1", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:BRAKESLV1", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("brakeslv2", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent("tuner-autos:BRAKESLV2", source, item.name)
  end)
  QBCore.Functions.CreateUseableItem("brakeslv3", function(source, item)
    local Player = QBCore.Functions.GetPlayer(src)
  ...
  AddEventHandler('tuner-autos:RemoveTurbo', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['turbo'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveTranslv1', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['translv1'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveTranslv2', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['translv2'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveTranslv3', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['translv3'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveEnglv1', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['englv1'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveEnglv2', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['englv2'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveEnglv3', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['englv3'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveEnglv4', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['englv4'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveBrakeslv1', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['brakeslv1'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveBrakeslv2', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['brakeslv2'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveBrakeslv3', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['brakeslv3'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveSuslv1', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['suslv1'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveSuslv2', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['suslv2'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveSuslv3', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['suslv3'], "remove")
  end)
  ...
  AddEventHandler('tuner-autos:RemoveSuslv4', function()
    ...
    TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['suslv4'], "remove")
  end)
...
AddEventHandler("tuner:EnginesCraft1", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 25 and metalscrap.amount >= 25 and plastic.amount >= 25 and aluminum.amount >= 25 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["englv1"], "add")
...
AddEventHandler("tuner:EnginesCraft2", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 50 and metalscrap.amount >= 50 and plastic.amount >= 50 and aluminum.amount >= 50 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["englv2"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:EnginesCraft3", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 100 and metalscrap.amount >= 100 and plastic.amount >= 100 and aluminum.amount >= 100 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["englv3"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:EnginesCraft4", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 150 and metalscrap.amount >= 150 and plastic.amount >= 150 and aluminum.amount >= 150 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["englv4"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:TransmissionCraft1", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 25 and metalscrap.amount >= 25 and plastic.amount >= 25 and aluminum.amount >= 25 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["translv1"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:TransmissionCraft2", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 50 and metalscrap.amount >= 50 and plastic.amount >= 50 and aluminum.amount >= 50 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["translv2"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:TransmissionCraft3", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 100 and metalscrap.amount >= 100 and plastic.amount >= 100 and aluminum.amount >= 100 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["translv3"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:BrakesCraft1", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 25 and metalscrap.amount >= 25 and plastic.amount >= 25 and plastic.amount >= 25 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["brakeslv1"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:BrakesCraft2", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 50 and metalscrap.amount >= 50 and plastic.amount >= 50 and aluminum.amount >= 50 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["brakeslv2"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:BrakesCraft3", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 100 and metalscrap.amount >= 100 and plastic.amount >= 100 and aluminum.amount >= 100 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["brakeslv3"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:SuspensionCraft1", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 25 and metalscrap.amount >= 25 and plastic.amount >= 25 and aluminum.amount >= 25 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["suslv1"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:SuspensionCraft2", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 50 and metalscrap.amount >= 50 and plastic.amount >= 50 and aluminum.amount >= 50 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["suslv2"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:SuspensionCraft3", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 100 and metalscrap.amount >= 100 and plastic.amount >= 100 and aluminum.amount >= 100 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["suslv3"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:SuspensionCraft4", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 100 and metalscrap.amount >= 100 and plastic.amount >= 100 and aluminum.amount >= 100 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["suslv4"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
AddEventHandler("tuner:TurboCraft", function()
    ...
    if metalscrap ~= nil and steel ~= nil and plastic ~= nil and aluminum ~= nil then
        ...
        if steel.amount >= 150 and metalscrap.amount >= 150 and plastic.amount >= 150 and aluminum.amount >= 150 then
            ...
            TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["turbo"], "add")
            TriggerClientEvent('QBCore:Notify', src, 'Item Crafted.')
        else
            TriggerClientEvent('QBCore:Notify', src, 'You do not have the correct items.', 'error')
        end
...
QBCore.Functions.CreateCallback('tuner-autos:IsMechanicAvailable', function(source, cb)
	local amount = 0
