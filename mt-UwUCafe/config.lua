...
Config.Ped = {-601.5, -1054.57, 21.55,"Sr Manel",91.22,0x94562DD7,"a_m_m_farmer_01"} -- ordem: coords - nome (label) - heading - hash - nome de spawn do ped
Config.PedTargetLoc = vector3(-601.5, -1054.57, 22.55) -- Localização do target do ped (deve ser o mesmo do ped)
