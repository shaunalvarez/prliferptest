...
Config.Locations = {	
	...
	{	job = "mechanic",
		...
		store = { { coords = vector3(-232.71, -1316.13, 30.89), w = 0.85, d = 1.8, heading = 359.0, }, },
		crafting = { { coords = vector3(-242.62, -1316.39, 30.89), w = 2.8, d = 1.0, heading = 270.0, }, },
		clockin = { { coords = vector3(-198.49, -1335.77, 30.89), heading = 0, }, },
		garage = { spawn = vector4(-182.74, -1317.61, 30.63, 357.23),
					out = vector4(-187.25, -1310.55, 31.3, 270.52),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
       -- payments = { coords = vector3(-199.09, -1338.4, 30.89), heading = 0.0, img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png width=150px></p>" },
	...
	{	job = "mechanic",
		...
		stash = { { coords = vector3(914.88, -2099.41, 30.46), w = 3.6, d = 0.6, heading = 0, }, },
		store = { { coords = vector3(914.09, -2126.88, 30.46), w = 0.85, d = 1.8, heading = 359.0, }, },
		crafting = { { coords = vector3(915.9, -2105.96, 30.46), w = 2.8, d = 1.0, heading = 270.0, }, },
		clockin = { { coords = vector3(873.44, -2100.75, 30.46), heading = 85, }, },
		garage = { spawn = vector4(862.41, -2129.15, 30.57, 359.1),
					out = vector4(868.66, -2131.27, 30.59, 79.29),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
       -- payments = { coords = vector3(-199.09, -1338.4, 30.89), heading = 0.0, img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png width=150px></p>" },
		blip = vector3(892.72, -2113.02, 30.46),
		bliplabel = "East Workshop",
		blipcolor = 5,
		discordlink = "",
		discordcolour = 16711680,
		discordimg = "https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png",
