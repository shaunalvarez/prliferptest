...
["duty"] = {
    [1] = vector3(310.57, -597.12, 43.28),
    [2] = vector3(-256.31, 6328.35, 32.43),
},
["vehicle"] = {
    [1] = vector4(331.58, -579.37, 28.8, 332.42),
    [2] = vector4(-264.73, 6338.62, 32.43, 313.26),
},
["helicopter"] = {
    [1] = vector4(351.58, -587.45, 74.16, 160.5),
    [2] = vector4(-275.5, 6326.34, 32.43, 306.25),
},
["armory"] = {
    [1] = vector3(306.89, -601.86, 43.28),
    [2] = vector3(-247.88, 6327.17, 32.43),
},
["roof"] = {
    --[1] = vector4(338.5, -583.85, 74.16, 245.5),
    --[2] = vector4(340.06, -584.73, 28.8, 243.72),
},
["main"] = {
    --[1] = vector3(332.36, -595.59, 43.28),
},
["stash"] = {
    [1] = vector3(303.8, -569.63, 43.28),
    [1] = vector3(-249.77, 6325.29, 32.43),

},
    ["beds"] = {
        [1] = {coords = vector4(311.1, -582.99, 44.2, 334.34), taken = false, model = 1631638868},
	--- paleto
	    [2] = {coords = vector4(-255.93, 6311.88, 33.36, 219.82), taken = false, model = 2117668672},

    },
    ["jailbeds"] = {
        [1] = {coords = vector4(462.16, -975.14, 26.38, 175.09), taken = false, model = 2117668672},
        [2] = {coords = vector4(459.27, -975.25, 26.38, 178.33), taken = false, model = 2117668672},
        [3] = {coords = vector4(456.57, -975.31, 26.38, 179.99), taken = false, model = 2117668672},
    },
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(304.27, -600.33, 43.28, 272.249)},
        [2] = {label = Lang:t('info.pb_hospital'), coords = vector4(-254.16, 6333.73, 32.43, 115.02)}     
    }
}
